/*
 ...
 Source Schema         : Household-Waste-Management
...
-- Records of feedback
-- ----------------------------
INSERT INTO `feedback` VALUES (2, 2, '积分兑换的物品没有发货', '积分兑换的物品没有发货', '积分兑换的物品没有发货', '2026-06-07 16:53:09', '我来确认一下，给你发放', '2026-06-07 17:10:30', '已回复');
INSERT INTO `feedback` VALUES (3, 3, '我的积分没到账', '我的积分没到账', '我的积分没到账', '2026-06-07 16:57:53', NULL, NULL, '待回复');
...
-- ----------------------------
INSERT INTO `garbage_launch` VALUES (4, 2, 7, 7, '干垃圾', 'http://localhost:9090/files/download/废报纸图片.jpg', '2026-06-06 17:21:50');
INSERT INTO `garbage_launch` VALUES (5, 3, 6, 4, '干垃圾', 'http://localhost:9090/files/download/旧衣服图片.png', '2026-06-06 17:31:28');
INSERT INTO `garbage_launch` VALUES (6, 2, 6, 4, '干垃圾', 'http://localhost:9090/files/download/有害垃圾02.jpg', '2026-06-06 17:32:00');
INSERT INTO `garbage_launch` VALUES (7, 2, 6, 4, '湿垃圾', 'http://localhost:9090/files/download/厨余垃圾01.jpg', '2026-06-07 17:39:05');
INSERT INTO `garbage_launch` VALUES (8, 2, 6, 4, '有害垃圾', 'http://localhost:9090/files/download/有害垃圾01.jpg', '2026-06-07 17:39:14');
INSERT INTO `garbage_launch` VALUES (9, 2, 6, 4, '干垃圾', 'http://localhost:9090/files/download/废报纸图片.jpg', '2026-06-07 17:39:20');
...
-- Records of notice
-- ----------------------------
INSERT INTO `notice` VALUES (1, '今天天气真的不错', '今天天气很好!是进行垃圾回收的好日子哦！', '2026-05-18 07:51:17');
INSERT INTO `notice` VALUES (2, '积分功能维护', '由于部分用户反馈积分数量显示不正确，平台将会于今晚20:00至明早8:00进行项目维护，请大家在此期间内停止使用积分功能，很抱歉对大家造成困扰，感谢理解。', '2026-05-20 15:52:22');
INSERT INTO `notice` VALUES (3, '宣传模块内容上新啦！', '平台新增《低碳生活》宣传模块，请大家前往查阅哦！', '2026-05-25 18:52:56');
...
-- ----------------------------
INSERT INTO `recovery_records` VALUES (17, 2, 3, 3, 3, 1, 10, '2026-06-07 10:24:00', NULL, 'http://localhost:9090/files/download/旧书图片.jpg', '通过', NULL);
INSERT INTO `recovery_records` VALUES (18, 2, 3, 3, 3, 1, 10, '2026-06-08 10:24:00', NULL, 'http://localhost:9090/files/download/旧书图片.jpg', '拒绝', '111');
INSERT INTO `recovery_records` VALUES (19, 2, 6, 7, 7, 1, 20, '2026-06-08 10:59:00', '请尽快审核！谢谢', 'http://localhost:9090/files/download/铝制易拉罐图片.jpg', '通过', NULL);
INSERT INTO `recovery_records` VALUES (20, 2, 5, 6, 4, 1, 10, '2026-06-08 11:01:12', NULL, 'http://localhost:9090/files/download/废报纸图片.jpg', '通过', NULL);
INSERT INTO `recovery_records` VALUES (21, 3, 6, 6, 4, 1, 20, '2026-06-08 16:01:08', '11', 'http://localhost:9090/files/download/铝制易拉罐图片.jpg', '通过', NULL);
INSERT INTO `recovery_records` VALUES (22, 3, 6, 6, 4, 1, 20, '2026-06-08 16:04:04', '11', 'http://localhost:9090/files/download/铝制易拉罐图片.jpg', '通过', NULL);
INSERT INTO `recovery_records` VALUES (23, 3, 5, 6, 4, 1, 10, '2026-06-10 17:01:08', NULL, 'http://localhost:9090/files/download/废报纸图片.jpg', '通过', NULL);
INSERT INTO `recovery_records` VALUES (24, 2, 3, 3, 3, 1, 10, '2026-06-10 12:45:23', NULL, 'http://localhost:9090/files/download/旧书图片.jpg', '拒绝', '222');
INSERT INTO `recovery_records` VALUES (25, 2, 3, 3, 3, 1, 10, '2026-06-10 17:21:12', NULL, 'http://localhost:9090/files/download/旧书图片.jpg', '通过', NULL);
INSERT INTO `recovery_records` VALUES (26, 3, 6, 6, 4, 1, 20, '2026-06-12 18:04:45', NULL, 'http://localhost:9090/files/download/铝制易拉罐图片.jpg', '通过', NULL);
INSERT INTO `recovery_records` VALUES (27, 2, 3, 3, 3, 1, 10, '2026-06-12 19:21:23', NULL, 'http://localhost:9090/files/download/旧书图片.jpg', '通过', NULL);
...
-- ----------------------------
INSERT INTO `score_exchange` VALUES (3, 2, 5, 1, 30, '小蓝', '10933338890', '长沙市开福区央视大厦', '2026-06-07 15:46:37', '已取消');
INSERT INTO `score_exchange` VALUES (4, 2, 5, 1, 30, '1', '1', '1', '2026-06-07 15:54:32', '已取消');
INSERT INTO `score_exchange` VALUES (5, 2, 5, 1, 30, '小蓝', '10933338890', '长沙市望城区体育馆', '2026-06-07 15:55:53', '已签收');
INSERT INTO `score_exchange` VALUES (6, 3, 5, 1, 30, '小粉', '18887776666', '湘潭市市雨湖区香袋大学', '2026-06-07 16:05:07', '待派送');
